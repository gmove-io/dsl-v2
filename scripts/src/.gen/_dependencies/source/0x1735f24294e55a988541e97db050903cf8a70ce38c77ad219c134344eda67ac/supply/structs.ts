...
import {Supply as Supply1} from "../../0xcdbd730f422a89174ee4717e97a3db1c48b008f969eec00846a0d685b2437f8a/utils-supply/structs";
...
export class Supply<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V1}::supply::Supply`; static readonly $numTypeParams = 1;
 ...
 frozen: bcs.bool(), inner: Supply1.bcs

}) };

 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): Supply<ToPhantomTypeArgument<T>> { return Supply.reified( typeArg, ).new( { frozen: decodeFromFields("bool", fields.frozen), inner: decodeFromFields(Supply1.reified(), fields.inner) } ) }
 ...
 return Supply.reified( typeArg, ).new( { frozen: decodeFromFieldsWithTypes("bool", item.fields.frozen), inner: decodeFromFieldsWithTypes(Supply1.reified(), item.fields.inner) } ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): Supply<ToPhantomTypeArgument<T>> { return Supply.reified( typeArg, ).new( { frozen: decodeFromJSONField("bool", field.frozen), inner: decodeFromJSONField(Supply1.reified(), field.inner) } ) }
