...
export class Witness<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V1}::witness::Witness`; static readonly $numTypeParams = 1;

 readonly $typeName = Witness.$typeName;

 readonly $fullTypeName: `${typeof PKG_V1}::witness::Witness<${PhantomToTypeStr<T>}>`;
 ...
 return Witness.fromBcs( typeArg, fromB64(res.data.bcs.bcsBytes) ); }
...
export class WitnessGenerator<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V1}::witness::WitnessGenerator`; static readonly $numTypeParams = 1;

 readonly $typeName = WitnessGenerator.$typeName;

 readonly $fullTypeName: `${typeof PKG_V1}::witness::WitnessGenerator<${PhantomToTypeStr<T>}>`;
 ...
 return WitnessGenerator.fromBcs( typeArg, fromB64(res.data.bcs.bcsBytes) ); }
