...
export function isI128(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::i128_type::I128`; }

export interface I128Fields { bits: ToField<"u128"> }

export type I128Reified = Reified< I128, I128Fields >;

export class I128 implements StructClass { static readonly $typeName = `${PKG_V1}::i128_type::I128`; static readonly $numTypeParams = 0;

 readonly $typeName = I128.$typeName;

 readonly $fullTypeName: `${typeof PKG_V1}::i128_type::I128`;

 readonly $typeArgs: [];

 readonly bits: ToField<"u128">

 private constructor(typeArgs: [], fields: I128Fields, ) { this.$fullTypeName = composeSuiType( I128.$typeName, ...typeArgs ) as `${typeof PKG_V1}::i128_type::I128`; this.$typeArgs = typeArgs;

 this.bits = fields.bits; }

 static reified( ): I128Reified { return { typeName: I128.$typeName, fullTypeName: composeSuiType( I128.$typeName, ...[] ) as `${typeof PKG_V1}::i128_type::I128`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => I128.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => I128.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => I128.fromBcs( data, ), bcs: I128.bcs, fromJSONField: (field: any) => I128.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => I128.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => I128.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => I128.fetch( client, id, ), new: ( fields: I128Fields, ) => { return new I128( [], fields ) }, kind: "StructClassReified", } }
 ...
 return I128.fromBcs( fromB64(res.data.bcs.bcsBytes) ); }
