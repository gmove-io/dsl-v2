...
export function isI64(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::i64_type::I64`; }

export interface I64Fields { bits: ToField<"u64"> }

export type I64Reified = Reified< I64, I64Fields >;

export class I64 implements StructClass { static readonly $typeName = `${PKG_V1}::i64_type::I64`; static readonly $numTypeParams = 0;

 readonly $typeName = I64.$typeName;

 readonly $fullTypeName: `${typeof PKG_V1}::i64_type::I64`;

 readonly $typeArgs: [];

 readonly bits: ToField<"u64">

 private constructor(typeArgs: [], fields: I64Fields, ) { this.$fullTypeName = composeSuiType( I64.$typeName, ...typeArgs ) as `${typeof PKG_V1}::i64_type::I64`; this.$typeArgs = typeArgs;

 this.bits = fields.bits; }

 static reified( ): I64Reified { return { typeName: I64.$typeName, fullTypeName: composeSuiType( I64.$typeName, ...[] ) as `${typeof PKG_V1}::i64_type::I64`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => I64.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => I64.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => I64.fromBcs( data, ), bcs: I64.bcs, fromJSONField: (field: any) => I64.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => I64.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => I64.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => I64.fetch( client, id, ), new: ( fields: I64Fields, ) => { return new I64( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromFields( fields: Record<string, any> ): I64 { return I64.reified( ).new( { bits: decodeFromFields("u64", fields.bits) } ) }
 ...
 static fromJSONField( field: any ): I64 { return I64.reified( ).new( { bits: decodeFromJSONField("u64", field.bits) } ) }
