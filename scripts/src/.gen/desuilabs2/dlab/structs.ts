...
export class Upgrade implements StructClass { static readonly $typeName = `${PKG_V2}::dlab::Upgrade`; static readonly $numTypeParams = 0;

 readonly $typeName = Upgrade.$typeName;

 readonly $fullTypeName: `${typeof PKG_V2}::dlab::Upgrade`;
